...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.socket.on('data:date', function (date) {
            ...
            _this.dates.push(jsdate.toLocaleTimeString('en', { year: 'numeric', month: 'short', day: 'numeric' }));
        });
        this.dataService.getData().subscribe(function () {
            _this.chart = new chart_js__WEBPACK_IMPORTED_MODULE_3__["Chart"]('canvas', {
                type: 'line',
                data: {
                    labels: _this.dates,
                    datasets: [
...
var DataService = /** @class */ (function () {
    function DataService(http) {
        this.http = http;
        this.accessUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].serverUrl + "/api/data/";
    ...
    DataService.prototype.getData = function () {
        return this.http.get(this.accessUrl, { headers: this.headers });
    };
...
module.exports = __webpack_require__(/*! C:\code\energy-monitor\public\src\main.ts */"./src/main.ts");
